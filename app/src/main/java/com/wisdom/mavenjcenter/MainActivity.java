...
import com.wisdom.irecyclerview.IRecyclerView;
import com.wisdom.irecyclerview.ProgressStyle;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (IRecyclerView)this.findViewById(R.id.recyclerview);
        ...
        mRecyclerView.setScrollAlphaChangeListener(new IRecyclerView.ScrollAlphaChangeListener() {
            @Override
        ...
        mRecyclerView.setLoadingListener(new IRecyclerView.LoadingListener() {
            @Override
